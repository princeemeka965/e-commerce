        ...
        <div className="flex w-full flex-col lg:justify-center md:justify-center sign-block">
          <div className="w-full flex justify-center div-left">
            <div className="lg:w-3/5 md:w-3/5 w-full flex flex-col">
              <p className="text-3xl font-bold text-center">E-MARKETZ</p>
              ...
              >
                ...
                <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96" @submit.prevent="submitForm">
                  <div class="flex flex-col gap-6 mb-1">
                    ...
                    <div class="relative min-h-11 w-full min-w-[200px]">
                      <input
                      ...
                      <div v-if="v$.name.$invalid && v$.name.$dirty">
                        <span v-for="(error, index) in v$.name.$errors" :key="index" class="capitalize text-xs text-red-500">
                    ...
                    <div class="relative min-h-11 w-full min-w-[200px]">
                      ...
                      <div v-if="v$.email.$invalid && v$.email.$dirty">
                        <span v-for="(error, index) in v$.email.$errors" :key="index" class="capitalize text-xs text-red-500">
                         {{ error.$property }} {{ error.$message }}
                        </span>
                      </div>
                    </div>
                    ...
                    <div class="relative min-h-11 w-full min-w-[200px]">
                      ...
                      <div v-if="v$.password.$invalid && v$.password.$dirty">
                        <span v-for="(error, index) in v$.password.$errors" :key="index" class="capitalize text-xs text-red-500">
                         {{ error.$property }} {{ error.$message }}
                        </span>
                      </div>
                    </div>
...
<style scoped>
.bg-market {
  background-image: url('@/assets/banner_1.jpeg');
